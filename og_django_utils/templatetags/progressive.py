...
def render_progressive_as_bg(
    context, image, variation=None, classes="", min_variation="min", sm_variation=None, always_load=False, **kwargs
):
...
def render_progressive(
    ...
    **kwargs,
    ...
    <figure class="progressive {}">
        ...
        loader_context,
        progress,
        tag_context["loader_class"],
        tag_context["always_load_class"],
        classes,
        tag_context["thumb_image"],
        tag_context["data_params"],
    )
    return mark_safe(html_tag)
